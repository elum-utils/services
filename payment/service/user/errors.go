...
var (
	...
	ErrCheckoutNotInitialized = serviceerrors.New(serviceerrors.CodeNotReady, "payment checkout service is not initialized")
	...
	ErrProductNotInitialized = serviceerrors.New(serviceerrors.CodeNotReady, "payment product service is not initialized")
	// ErrSubscriptionNotInitialized means subscription operations are unavailable.
	ErrSubscriptionNotInitialized = serviceerrors.New(serviceerrors.CodeNotReady, "payment subscription service is not initialized")
)
