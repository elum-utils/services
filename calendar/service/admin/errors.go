...
var (
	...
	ErrCalendarRangeInvalid        = serviceerrors.New(serviceerrors.CodeInvalidFields, "calendar admin start_at must be before end_at")
	ErrCalendarModeInvalid         = serviceerrors.New(serviceerrors.CodeInvalidFields, "calendar admin mode is invalid")
	...
	ErrRewardRequired              = serviceerrors.New(serviceerrors.CodeInvalidFields, "calendar admin reward scope, key, quantity and position are required")
	ErrRewardQuantityUnit          = serviceerrors.New(serviceerrors.CodeInvalidFields, "calendar admin quantity reward must not have duration unit")
	ErrRewardDurationUnit          = serviceerrors.New(serviceerrors.CodeInvalidFields, "calendar admin duration reward requires a valid duration unit")
	ErrRewardTypeUnsupported       = serviceerrors.New(serviceerrors.CodeInvalidFields, "calendar admin reward type must be quantity or duration")
	ErrLocalizationRequired        = serviceerrors.New(serviceerrors.CodeInvalidFields, "calendar admin localization scope, locale and title are required")
)
